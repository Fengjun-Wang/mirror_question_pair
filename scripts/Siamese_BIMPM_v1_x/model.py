...
class BIMPM(nn.Module):
    def __init__(self,
        ...
        ##---Aggregation layer---##
        self.al = nn.LSTM(input_size = 8*self.number_perspective,
...
class Model(object):
    ...
    def train(self,train_dg,valid_dg,criterion, optimizer, scheduler, num_epochs, early_stop_rounds):
        ...
        for epoch in xrange(num_epochs):
            if early_stop_flag:
                break
            # print(self.model.MW1)
            # print(self.model.MW2)
            # print(self.model.MW3)
            # print(self.model.MW4)
            # print(self.model.MW5)
            # print(self.model.MW6)
            # print(self.model.MW7)
            # print(self.model.MW8)
