...
class Siamese_CNN(nn.Module):
    def __init__(self,pre_trained_embedding,is_freeze):
        ...
        self.dropout = nn.Dropout(p=0.4)  ##TODO  0.3->0.4
        self.conv1d_size2 = nn.Conv1d(in_channels=input_channel_len,
                                      out_channels=100, ##TODO 50->100
                                      kernel_size=2,
                                      stride=1,
                                      padding=1)
        ...
        self.conv1d_size4 = nn.Conv1d(in_channels=input_channel_len,
                                      ...
                                      stride=1,
                                      padding=1)
        self.out_hidden1 = nn.Linear(600,300)##TODO 300->600
...
def train():
    ...
    ### Train
    siamese_model.train(train_dg,val_dg,criteria,optimizer_ft,exp_lr_scheduler,50) ##TODO 25->50
