...
class Siamese_CNN(nn.Module):
    def __init__(self,pre_trained_embedding,is_freeze,output_channels): ##TODO Parameterize output_channels
        ...
        self.conv1d_size4 = nn.Conv1d(in_channels=input_channel_len,
                                      ...
                                      stride=1,
                                      padding=1)
        self.out_hidden1 = nn.Linear(6*output_channels+1,300) ##TODO Add 1 for similarity
    ...
    def forward(self, input):
        ...
        similarity = self.similarity(q1_concat,q2_concat)
        q_concat = torch.cat((q1_concat,q2_concat,similarity),dim=1) ##Nx601
